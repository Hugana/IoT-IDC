<!-- Node-RED editor code for the FlexDash Slider widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/slider-info.js'
  ...
  flexdash.insert_general_edit("fd-slider", "fd-tab-general", true)
...
<script type="text/html" data-template-name="fd-slider">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-slider">
  <p id="fd-slider-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
