<!-- Node-RED editor code for the FlexDash Label widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/label-info.js'
  ...
  flexdash.insert_general_edit("fd-label", "fd-tab-general", false)
...
<script type="text/html" data-template-name="fd-label">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-label">
  <p id="fd-label-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
