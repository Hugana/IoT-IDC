<!-- Node-RED editor code for the FlexDash Toggle widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/toggle-info.js'
  ...
  flexdash.insert_general_edit("fd-toggle", "fd-tab-general", true)
...
<script type="text/html" data-template-name="fd-toggle">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-toggle">
  <p id="fd-toggle-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
