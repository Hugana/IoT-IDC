// Node-RED node implementation for FlexDash widget DropdownSelect
...
module.exports = function (RED) {
  ...
  "value": {
    ...
    "name_text": "Payload",
    "name_kebab": "value",
    "tip": "Value of selection to show in the box. ",
    "default": null,
    "default_html": null,
    "input_type": "any"
  },
  ...
  "labels": {
    ...
    "name_text": "Labels",
    "name_kebab": "labels",
    "tip": "Array of labels for choices. ",
    "default": [],
    "default_html": "[]",
    "type": "array",
    "input_type": "json"
  ...
  "allow_multiple": {
    "msg_name": "allow_multiple",
    "name": "allow_multiple",
    "name_text": "Allow Multiple",
    "name_kebab": "allow-multiple",
    "tip": "",
    "default": false,
    "default_html": "false",
    "type": "boolean",
  ...
  "color": {
    ...
    "name_text": "Color",
    "name_kebab": "color",
    "tip": "Background color of button. ",
    "default": "primary",
  ...
  function DropdownSelect(config) {
    ...
    const widget = RED.plugins.get('flexdash').initWidget(this, config, 'DropdownSelect')
  ...
  RED.nodes.registerType("fd-dropdown-select", DropdownSelect)
}
