<!-- Node-RED editor code for the FlexDash TextView widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/text-view-info.js'
  ...
  flexdash.insert_general_edit("fd-text-view", "fd-tab-general", true)
...
<script type="text/html" data-template-name="fd-text-view">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-text-view">
  <p id="fd-text-view-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
