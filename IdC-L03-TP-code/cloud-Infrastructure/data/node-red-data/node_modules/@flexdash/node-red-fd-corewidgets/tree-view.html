<!-- Node-RED editor code for the FlexDash TreeView widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/tree-view-info.js'
  ...
  flexdash.insert_general_edit("fd-tree-view", "fd-tab-general", false)
...
<script type="text/html" data-template-name="fd-tree-view">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-tree-view">
  <p id="fd-tree-view-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
