<!-- Node-RED editor code for the FlexDash ValueSequence widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/value-sequence-info.js'
  ...
  flexdash.insert_general_edit("fd-value-sequence", "fd-tab-general", true)
...
<script type="text/html" data-template-name="fd-value-sequence">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-value-sequence">
  <p id="fd-value-sequence-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
