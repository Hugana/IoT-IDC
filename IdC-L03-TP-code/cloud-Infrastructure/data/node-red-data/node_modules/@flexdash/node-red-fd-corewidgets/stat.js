...
module.exports = function (RED) {
  ...
  "precision": {
    ...
    "name": "precision",
    "name_text": "Precision",
    "name_kebab": "precision",
    "tip": "Number of significant digits to show. ",
    "default": 3,
    "default_html": "3",
    "type": "number",
    "input_type": "num"
  ...
  function Stat(config) {
    ...
    const widget = RED.plugins.get('flexdash').initWidget(this, config, 'Stat')
  ...
  RED.nodes.registerType("fd-stat", Stat)
}
