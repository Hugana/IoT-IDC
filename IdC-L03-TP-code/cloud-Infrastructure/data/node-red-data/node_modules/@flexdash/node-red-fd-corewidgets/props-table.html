<!-- Node-RED editor code for the FlexDash PropsTable widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/props-table-info.js'
  ...
  flexdash.insert_general_edit("fd-props-table", "fd-tab-general", true)
...
<script type="text/html" data-template-name="fd-props-table">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-props-table">
  <p id="fd-props-table-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
