...
module.exports = function (RED) {
  ...
  "autoscroll": {
    "msg_name": "autoscroll",
    "name": "autoscroll",
    "name_text": "Autoscroll",
    "name_kebab": "autoscroll",
    "tip": "Auto-scroll to bottom of text (incompatible with editable). ",
    "default": true,
    "default_html": "true",
    "type": "boolean",
    "input_type": "bool"
  ...
  function TextView(config) {
    ...
    const widget = RED.plugins.get('flexdash').initWidget(this, config, 'TextView')
    ...
    this.on("input", msg => {
      ...
      if (onNodeRedCustom) {
        ...
        if ('text' && 'payload' in props) {
          props['text'] = props.payload
  ...
  RED.nodes.registerType("fd-text-view", TextView)
}
