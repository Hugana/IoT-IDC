<!-- Node-RED editor code for the FlexDash Stat widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/stat-info.js'
  ...
  flexdash.insert_general_edit("fd-stat", "fd-tab-general", false)
...
<script type="text/html" data-template-name="fd-stat">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-stat">
  <p id="fd-stat-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
