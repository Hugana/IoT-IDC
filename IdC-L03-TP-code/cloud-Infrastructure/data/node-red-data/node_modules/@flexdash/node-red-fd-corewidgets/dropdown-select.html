<!-- Node-RED editor code for the FlexDash DropdownSelect widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/dropdown-select-info.js'
  ...
  flexdash.insert_general_edit("fd-dropdown-select", "fd-tab-general", true)
...
<script type="text/html" data-template-name="fd-dropdown-select">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-dropdown-select">
  <p id="fd-dropdown-select-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
