<!-- Node-RED editor code for the FlexDash PopupButton widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/popup-button-info.js'
  ...
  flexdash.insert_general_edit("fd-popup-button", "fd-tab-general", false)
...
<script type="text/html" data-template-name="fd-popup-button">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-popup-button">
  <p id="fd-popup-button-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
