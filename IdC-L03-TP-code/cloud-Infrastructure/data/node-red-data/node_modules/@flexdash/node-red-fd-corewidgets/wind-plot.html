<!-- Node-RED editor code for the FlexDash WindPlot widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/wind-plot-info.js'
  ...
  flexdash.insert_general_edit("fd-wind-plot", "fd-tab-general", true)
...
<script type="text/html" data-template-name="fd-wind-plot">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-wind-plot">
  <p id="fd-wind-plot-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
