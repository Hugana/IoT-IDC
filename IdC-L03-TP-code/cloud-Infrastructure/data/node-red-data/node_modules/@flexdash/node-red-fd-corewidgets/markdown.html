<!-- Node-RED editor code for the FlexDash Markdown widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/markdown-info.js'
  ...
  flexdash.insert_general_edit("fd-markdown", "fd-tab-general", false)
...
<script type="text/html" data-template-name="fd-markdown">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-markdown">
  <p id="fd-markdown-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
