<!-- Node-RED editor code for the FlexDash Gauge widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/gauge-info.js'
  ...
  flexdash.insert_general_edit("fd-gauge", "fd-tab-general", false)
...
<script type="text/html" data-template-name="fd-gauge">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-gauge">
  <p id="fd-gauge-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
