<!-- Node-RED editor code for the FlexDash PushButton widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/push-button-info.js'
  ...
  flexdash.insert_general_edit("fd-push-button", "fd-tab-general", true)
...
<script type="text/html" data-template-name="fd-push-button">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-push-button">
  <p id="fd-push-button-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
