<!-- Node-RED editor code for the FlexDash TextField widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/text-field-info.js'
  ...
  flexdash.insert_general_edit("fd-text-field", "fd-tab-general", true)
...
<script type="text/html" data-template-name="fd-text-field">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-text-field">
  <p id="fd-text-field-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
