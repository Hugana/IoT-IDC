...
module.exports = function (RED) {
  ...
  "title": {
    ...
    "default": "Time Plot Raw",
    "default_html": "'Time Plot Raw'"
  },
  "popup_info": {
    "name": "popup_info",
  ...
  function TimePlotRaw(config) {
    ...
    const widget = RED.plugins.get('flexdash').initWidget(this, config, 'TimePlotRaw')
...
onNodeRedCustom = (props, options) => {
  ...
  RED.nodes.registerType("fd-time-plot-raw", TimePlotRaw)
}
