<!-- Node-RED editor code for the FlexDash SparkLine widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/spark-line-info.js'
  ...
  flexdash.insert_general_edit("fd-spark-line", "fd-tab-general", false)
...
<script type="text/html" data-template-name="fd-spark-line">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-spark-line">
  <p id="fd-spark-line-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
