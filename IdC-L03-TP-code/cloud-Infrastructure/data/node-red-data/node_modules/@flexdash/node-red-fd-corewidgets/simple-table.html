<!-- Node-RED editor code for the FlexDash SimpleTable widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/simple-table-info.js'
  ...
  flexdash.insert_general_edit("fd-simple-table", "fd-tab-general", true)
...
<script type="text/html" data-template-name="fd-simple-table">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-simple-table">
  <p id="fd-simple-table-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
