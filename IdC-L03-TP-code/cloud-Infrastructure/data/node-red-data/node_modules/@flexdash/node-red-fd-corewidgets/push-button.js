...
module.exports = function (RED) {
  ...
  "icon": {
    ...
    "name_text": "Icon",
    "name_kebab": "icon",
    "tip": "Material-design-icon name w/mdi- prefix. ",
    "default": null,
    "default_html": null,
    "input_type": "any"
  }
  ...
  function PushButton(config) {
    ...
    const widget = RED.plugins.get('flexdash').initWidget(this, config, 'PushButton')
  ...
  RED.nodes.registerType("fd-push-button", PushButton)
}
