<!-- Node-RED editor code for the FlexDash NumberField widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/number-field-info.js'
  ...
  flexdash.insert_general_edit("fd-number-field", "fd-tab-general", true)
...
<script type="text/html" data-template-name="fd-number-field">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-number-field">
  <p id="fd-number-field-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
