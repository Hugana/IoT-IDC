...
module.exports = function (RED) {
  ...
  function Markdown(config) {
    ...
    const widget = RED.plugins.get('flexdash').initWidget(this, config, 'Markdown')
  ...
  RED.nodes.registerType("fd-markdown", Markdown)
}
