<!-- Node-RED editor code for the FlexDash TimelinePlot widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/timeline-plot-info.js'
  ...
  flexdash.insert_general_edit("fd-timeline-plot", "fd-tab-general", true)
...
<script type="text/html" data-template-name="fd-timeline-plot">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-timeline-plot">
  <p id="fd-timeline-plot-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
