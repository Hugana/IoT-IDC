<!-- Node-RED editor code for the FlexDash IFrame widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/iframe-info.js'
  ...
  flexdash.insert_general_edit("fd-iframe", "fd-tab-general", false)
...
<script type="text/html" data-template-name="fd-iframe">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-iframe">
  <p id="fd-iframe-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
