<!-- Node-RED editor code for the FlexDash DateTime widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/datetime-info.js'
  ...
  flexdash.insert_general_edit("fd-date-time", "fd-tab-general", false)
...
<script type="text/html" data-template-name="fd-date-time">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-date-time">
  <p id="fd-date-time-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
