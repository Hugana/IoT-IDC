<!-- Node-RED editor code for the FlexDash TimePlotRaw widget -->

<script type="module">
  // fetch the widget info: a bunch of JSON produced by gen-widget-node.js
  import widgetInfo from './resources/@flexdash/node-red-fd-corewidgets/time-plot-raw-info.js'
  ...
  flexdash.insert_general_edit("fd-time-plot-raw", "fd-tab-general", false)
...
<script type="text/html" data-template-name="fd-time-plot-raw">
  <div class="form-row">
...
<script type="text/markdown" data-help-name="fd-time-plot-raw">
  <p id="fd-time-plot-raw-help-text"><i>Ooops, this should have filled-in dynamically...</i></p>
</script>
